          ...
          <div className="space-y-0">
              ...
              >
                ...
                <div className="relative z-10 p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    Bridge International (BI) is a premier educational
                    institution in Bangkok, dedicated to guiding ambitious
                    students toward top universities around the world.
                  </p>
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
              ...
              >
                ...
                <div className="relative z-10 p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    ...
                    universities. Our expert faculty and proven curriculum
            ...
            <section className="w-full flex flex-col md:flex-row-reverse items-stretch">
              ...
              <div className="w-full md:w-1/2 bg-dark-blue flex flex-col justify-center p-6 md:p-10 space-y-4 md:space-y-6">
                ...
                <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                  At BI, we are committed to fostering academic excellence
                ...
                <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                  ...
                  opportunities make BI the perfect place to achieve your
                  academic goals and prepare for a global future.
                </p>
              </div>
            </section>
            ...
            <section className="w-full flex flex-col md:flex-row items-stretch">
              ...
              <div className="w-full md:w-1/2 bg- flex flex-col justify-center p-6 md:p-10 space-y-4 md:space-y-6">
                ...
                <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                  ...
                  <strong className=" text-brand-red">GED</strong>,{" "}
                  <strong className=" text-brand-red">IGCSE</strong>, and
                  <strong className=" text-brand-red"> A Levels</strong>,
                  tailored for students who are aiming to get into top
            ...
            <section className="w-full flex flex-col md:flex-row items-start py-8 md:py-14 px-4 md:px-6 gap-8 md:gap-12 relative overflow-hidden">
              <div className="w-full md:w-1/2 flex flex-col mt-4 justify-start">
                ...
                <p className="text-gray-300 text-base md:text-lg leading-relaxed font-manrope mb-4 md:mb-6">
                  ...
                  With an internationally aligned curriculum and a strong
                  emphasis on global citizenship, BI Bangkok empowers students
                  with the knowledge, skills, and confidence to thrive in an
                  ever-changing world.
                </p>
            ...
            <section className="w-full flex flex-col-reverse md:flex-row items-stretch">
              ...
              >
                ...
                <div className="relative z-10 p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    With small class sizes, our teachers focus on the unique
                    needs of each student. The Ontario Secondary School Diploma
                    offers a flexible pathway to Canadian and international
                    universities.
                  </p>
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    Students benefit from personalized attention and a
                    curriculum that emphasizes both academic excellence and
            ...
            <section className="w-full flex flex-col-reverse md:flex-row items-stretch">
              ...
              >
                ...
                <div className="relative z-10 p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    Flexible pathway for adult learners seeking to complete
                    their high school equivalency and advance to higher
                    education. Our GED program accommodates working
                    professionals and non-traditional students.
                  </p>
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    With flexible scheduling and comprehensive support, students
                    can achieve their educational goals while balancing other
                    life commitments.
                  </p>
                  <div className="flex flex-wrap gap-4 pt-4">
                    <Link
              ...
              <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="text-left mb-12 md:mb-16">
                  ...
                  <p className="text-lg md:text-2xl lg:text-3xl font-manrope font-bold text-brand-beige leading-relaxed drop-shadow-md">
                    Join a community where your success is our priority. We
                    offer personalized learning, state-of-the-art facilities,
                    and a supportive environment that nurtures every student's
                    potential.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
                  ...
                  <div className="group bg-black/40 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10 hover:border-brand-beige/50 transition-all duration-300">
                    ...
                    <p className="text-gray-300 font-manrope leading-relaxed text-sm md:text-base text-center sm:text-left">
                      Specializes in advanced calculus with research published
                      in 5 international journals. Passionate about making math
                      accessible.
                    </p>
                  </div>
              ...
              >
                ...
                <div className="relative z-10 p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                    ...
                    encourage critical thinking, and foster a love of learning.
                    At BI, your success is our mission.
                  </p>
                </div>
              </div>
