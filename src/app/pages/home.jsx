...
export default function HomePage({ language = "en" }) {
  const translations = {
    ...
    mm: {
      ...
      testimonialsTitle: "ကျွန်ုပ်တို့ကျောင်းသားများ ပြောသည်များ",
      learnMore: "ကျွန်ုပ်တို့အကြောင်း ပိုမိုလေ့လာပါ",
      explorePrograms: "ကျွန်ုပ်တို့၏ ပရိုဂရမ်များကို ရှာဖွေပါ",
      facultyTitle: "ကျွန်ုပ်တို့၏ ဂုဏ်ထူးဆောင် ဆရာများ",
      facultyDesc:
        "ကျွန်ုပ်တို့၏ ဆရာများသည် အနာဂတ်ခေါင်းဆောင်များကို ပြုစုပျိုးထောင်ရန် ရည်ရွယ်ထားသော အတွေ့အကြုံရှိ ပညာရှင်များနှင့် စက်မှုလုပ်ငန်း ကျွမ်းကျင်သူများ ပါဝင်သည်။",
      campusLifeTitle: "တက်ကြွသော ကျောင်းဝင်းဘဝ",
  ...
  return (
    <div
      className={`relative min-h-screen ${
        language === "mm" ? "font-myanmar" : "font-lora"
      }`}
    >
      {/* Global Background */}
      <div className="fixed inset-0 z-0">
      ...
      <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  icon: "🏢",
                  desc: t.facilitiesDesc,
                  gradient: "from-brand-beige/20 to-brand-beige/5",
                ...
                <div key={i} className="group">
                  <div
                    className={`bg-gradient-to-br ${item.gradient} backdrop-blur-sm border ${item.border} rounded-2xl p-8 text-center hover:scale-105 transition-all duration-500 h-full`}
                  >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: "Advanced Level Qualifications for university entry",
                  path: "/alevels",
                  color: "from-brand-beige to-brand-beige/70",
                  icon: "🎯",
                },
                {
                  name: "OSSD",
                  desc: "Ontario Secondary School Diploma, globally recognized",
                  path: "/ossd",
                ...
                {
                  name: "GED",
                  desc: "General Educational Development alternative diploma",
                  path: "/ged",
                  color: "from-brand-red/80 to-brand-beige/80",
                  icon: "⭐",
                },
              ].map((program, i) => (
                <Link key={i} to={program.path} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:bg-white/10 hover:scale-105 transition-all duration-500 h-full">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${program.color} rounded-2xl mx-auto mb-6 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300`}
                    >
                      {program.icon}
                    </div>
                    <h3
                    ...
                    <span className="inline-flex items-center text-brand-beige font-medium group-hover:text-white transition-colors">
                      Learn More
                      <svg
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-brand-red to-brand-beige mx-auto rounded-full"></div>
              <p
                className={`text-white/80 text-lg mt-6 max-w-3xl mx-auto ${
                  language === "mm" ? "font-myanmar" : "font-lora"
                }`}
              >
                {t.facultyDesc}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    <div className="relative mb-6">
                      <img
                        src={`/placeholder.svg?height=120&width=120&text=Faculty+${i}`}
                        alt={`Faculty Member ${i}`}
                        className="w-24 h-24 rounded-full mx-auto border-4 border-brand-beige/50 group-hover:border-brand-beige transition-colors duration-300"
                      />
                      <div className="absolute inset-0 rounded-full bg-gradient-to-t from-brand-red/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </div>
                    <h3
                    ...
                    <p className="text-brand-beige font-medium mb-2">
                      Department of {i % 2 === 0 ? "Science" : "Arts"}
                    </p>
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-brand-red to-brand-beige mx-auto rounded-full"></div>
              <p
                className={`text-white/80 text-lg mt-6 max-w-4xl mx-auto ${
                  language === "mm" ? "font-myanmar" : "font-lora"
                }`}
              >
                {t.facilitiesDesc}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  color: "from-brand-beige/20 to-brand-beige/5",
                },
                {
                  icon: "💻",
                  title: "Tech Hubs",
                ...
                },
                {
                  ...
                  color: "from-brand-red/15 to-brand-beige/10",
                },
                {
                  icon: "🎭",
                  title: "Arts Studios",
                  color: "from-brand-beige/15 to-brand-red/10",
                },
                {
                  icon: "🍽️",
                  title: "Dining Halls",
                  color: "from-brand-blue/15 to-brand-red/10",
                },
              ].map((item, i) => (
                <div key={i} className="group">
                  <div
                    className={`bg-gradient-to-br ${item.color} backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:scale-105 transition-all duration-500`}
                  >
                    <div className="text-5xl mb-4 transform group-hover:scale-110 transition-transform duration-300">
                      {item.icon}
                    </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { icon: "⚽", title: "Sports", desc: "Athletic programs" },
                {
                  icon: "🎨",
                  title: "Arts & Culture",
                ...
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    <div className="text-5xl mb-4 transform group-hover:scale-110 transition-transform duration-300">
                      {item.icon}
                    </div>
                    <h3
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { step: "1", title: "Inquire & Apply", icon: "📝" },
                { step: "2", title: "Submit Documents", icon: "📄" },
                { step: "3", title: "Interview & Assessment", icon: "💬" },
                { step: "4", title: "Receive Offer", icon: "🎉" },
              ].map((item, i) => (
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    ...
                    <div className="text-4xl font-bold text-brand-beige mb-4">
                      {item.step}
                    </div>
                    <h3
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500">
                ...
                >
                  Supporting students with demonstrated financial need to access
                  quality education.
                </p>
              </div>
            </div>
                ...
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    <img
                      src={`/placeholder.svg?height=100&width=100&text=Alumni+${i}`}
                      alt={`Alumni ${i}`}
                      className="w-20 h-20 rounded-full mx-auto mb-4 border-4 border-brand-beige/50 group-hover:border-brand-beige transition-colors duration-300"
                    />
                    <h3
                      className={`text-xl font-semibold text-white mb-2 ${
                        language === "mm" ? "font-myanmar" : "font-lora"
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    ...
                    <p className="text-brand-beige mb-2 font-medium">
                      Date: July {15 + i}, 2025
                    </p>
                    <p
                    ...
                    <Link
                      to="#"
                      className="inline-flex items-center text-brand-beige hover:text-white transition-colors font-medium"
                    >
                      Learn More
                      <svg
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    <div className="relative h-48 overflow-hidden">
                      <img
                        src={`/placeholder.svg?height=200&width=300&text=News+${i}`}
                        alt={`News ${i}`}
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <span className="text-sm text-brand-beige bg-brand-beige/10 px-2 py-1 rounded-lg">
                          July {10 + i}, 2025
                        </span>
                      </div>
                      <p
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { number: "2500+", label: "Graduates", icon: "🎓" },
                ...
                <div key={i} className="group">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    ...
                    <div className="text-4xl font-bold text-brand-beige mb-4 group-hover:scale-110 transition-transform duration-300">
                      {stat.number}
                    </div>
                    <div
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:scale-105 transition-all duration-500">
                    <div className="flex items-center mb-6">
                      <img
                        src={`/placeholder.svg?height=60&width=60&text=Student+${i}`}
                        alt={`Student ${i}`}
                        className="w-12 h-12 rounded-full mr-4 border-2 border-brand-beige/50"
                      />
                      <div>
                        <h4
                        ...
                        <p className="text-brand-beige text-sm font-medium">
                          Class of 2023
                        </p>
                      </div>
                    </div>
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <h2
              className={`text-5xl md:text-6xl lg:text-7xl font-semibold text-white mb-8 ${
                language === "mm" ? "font-myanmar" : "font-lora"
              }`}
            >
              {t.ctaTitle}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                to="/enquire"
                className="inline-flex items-center px-12 py-4 bg-gradient-to-r from-brand-red to-brand-red/80 text-white font-semibold rounded-xl hover:from-brand-red/90 hover:to-brand-red transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-brand-red/25"
              >
                <span
                  className={language === "mm" ? "font-myanmar" : "font-lora"}
                >
                  {t.applyNow}
                </span>
                <svg
              ...
              <Link
                to="/admission"
                className="inline-flex items-center px-12 py-4 bg-gradient-to-r from-brand-beige to-brand-beige/80 text-dark-primary font-semibold rounded-xl hover:from-brand-beige/90 hover:to-brand-beige transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-brand-beige/25"
              >
                <span
                  className={language === "mm" ? "font-myanmar" : "font-lora"}
                >
