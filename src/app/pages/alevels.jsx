        ...
        <div className="lg:w-1/2 bg-dark-blue flex items-center">
          <div className="p-8 md:p-16">
            ...
            <p className="text-lg md:text-xl text-white leading-relaxed">
              At BIC, we offer a two-year pathway. Both offer an entirely
              personalised journey for each student – from the first advisor
      ...
      <section className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="lg:w-1/2 bg-dark-blue flex items-center">
          <div className="p-8 md:p-16">
            ...
            <p className="text-lg md:text-xl text-white leading-relaxed">
              Every student follows their own Global Strategic Pathway at BIC.
