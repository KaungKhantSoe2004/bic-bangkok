        ...
        <div className="space-y-0">
          ...
          <section className="w-full py-12 sm:py-16 md:py-20 px-4 md:px-6 bg-grey-900">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="bg-black/40 rounded-2xl p-6 space-y-3">
                    <SkeletonText className="h-6 w-3/4" />
                    <SkeletonText className="h-4 w-full" />
                    <SkeletonText className="h-4 w-5/6" />
                  </div>
            ...
            <div className="absolute z-10 max-w-6xl mx-auto text-center px-4 md:px-6 space-y-4 md:space-y-8">
              ...
              <div className="max-w-4xl mx-auto">
                <p className="text-base sm:text-lg md:text-2xl text-gray-300 leading-relaxed font-manrope">
                  We can't wait to welcome you into our ambitious international community.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="w-full lg:w-1/2 bg-gray-800">
              <div className="p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                ...
                <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                  BI provides a supportive and globally recognized learning environment where students are guided by
                  experienced faculty and equipped with modern facilities. With a strong commitment to academic
                  excellence and personal growth, we prepare students for success at top universities worldwide.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-800 p-8 border-l-4 border-brand-red hover:bg-gray-700 transition-all duration-300">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-lora font-bold text-brand-beige">Age Requirement</h3>
                    <p className="text-gray-300 font-manrope">
                      Applicants must be at least <span className="font-bold text-brand-beige">15 years old</span> to be
                ...
                <div className="bg-gray-800 p-8 border-l-4 border-brand-red hover:bg-gray-700 transition-all duration-300">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-lora font-bold text-brand-beige">English Proficiency</h3>
                    <p className="text-gray-300 font-manrope">
                      Academic <span className="font-bold text-brand-beige">IELTS 5.5</span> or equivalent English
                ...
                <div className="bg-gray-800 p-8 border-l-4 border-brand-red hover:bg-gray-700 transition-all duration-300">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-lora font-bold text-brand-beige">Entry Assessment</h3>
                    <p className="text-gray-300 font-manrope">
                      Complete <span className="font-bold text-brand-beige">maths & science</span> assessments plus
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mt-16">
                <div className="bg-gray-800 p-8 max-w-2xl mx-auto">
                  <h3 className="text-2xl font-lora font-bold text-brand-beige mb-4">Ready to Begin?</h3>
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12 md:mb-16 space-y-6">
                ...
                <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                  Find answers to common questions about our admissions process, requirements, and timelines
                </p>
              </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        ...
                        >
                          <span
                            className={`text-xs font-bold ${openFaq === index ? "text-white" : "text-brand-beige"}`}
                          >
                            {index + 1}
                          </span>
                        </div>
                      ...
                      >
                        <svg
                          className={`w-5 h-5 transition-all duration-300 chevron-animation ${
                            openFaq === index ? "text-brand-red rotate-180 scale-110" : "text-brand-beige"
                          }`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        ...
                        {faq.additionalInfo && (
                          <div className="mt-4 p-4 bg-black/30 rounded-lg border-l-4 border-brand-red">
                            <p className="text-sm text-gray-300">
                              <span className="font-semibold text-brand-beige">Note:</span> {faq.additionalInfo}
                            </p>
                          </div>
                        )}
                      </div>
              ...
              <div className="text-center mt-12 md:mt-16 pt-8 border-t border-white/10">
                <h3 className="text-xl font-lora font-semibold text-brand-beige mb-4">Still have questions?</h3>
          ...
          <section className="w-full flex flex-col lg:flex-row items-stretch">
            ...
            <div className="w-full lg:w-1/2 bg-gray-800">
              <div className="p-6 md:p-10 flex flex-col justify-center h-full space-y-4 md:space-y-6">
                ...
                <p className="text-base md:text-lg font-manrope text-gray-300 max-w-xl">
                  Take the first step toward a brighter future today by joining a school committed to excellence,
                  growth, and opportunity. Secure your place and begin your journey toward academic success and global
                  recognition.
                </p>
              </div>
            </div>
